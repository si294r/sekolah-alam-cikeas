...
<p class="has-small-font-size" style="line-height:1.6">Sekolah Alam adalah sekolah formal yang konsep pendidikan, lingkungan belajar dan metode pembelajarannya menggunakan alam.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"icon-phone","style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":1.6}},"fontSize":"small"} -->
<p class="icon-phone has-small-font-size" style="font-style:normal;font-weight:600;line-height:1.6">+62 8111 1199 24</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"icon-envelope","style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":1.6}},"fontSize":"small"} -->
<p class="icon-envelope has-small-font-size" style="font-style:normal;font-weight:600;line-height:1.6">support@sac.co.id</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-fill follow-us icon-facebook"><a class="wp-block-button__link has-dark-blue-background-color has-background wp-element-button" style="border-radius:50%">fb</a></div>
<!-- /wp:button -->

<!-- wp:button {"backgroundColor":"dark-blue","className":"is-style-fill follow-us icon-instagram","style":{"border":{"radius":"50%"}}} -->
<div class="wp-block-button is-style-fill follow-us icon-instagram"><a class="wp-block-button__link has-dark-blue-background-color has-background wp-element-button" style="border-radius:50%">insta</a></div>
<!-- /wp:button -->

<!-- wp:button {"backgroundColor":"dark-blue","className":"is-style-fill follow-us icon-youtube","style":{"border":{"radius":"50%"}}} -->
<div class="wp-block-button is-style-fill follow-us icon-youtube"><a class="wp-block-button__link has-dark-blue-background-color has-background wp-element-button" style="border-radius:50%">yt</a></div>
<!-- /wp:button -->

<!-- wp:button {"backgroundColor":"dark-blue","className":"is-style-fill follow-us icon-linkedin","style":{"border":{"radius":"50%"}}} -->
<div class="wp-block-button is-style-fill follow-us icon-linkedin"><a class="wp-block-button__link has-dark-blue-background-color has-background wp-element-button" style="border-radius:50%">in</a></div>
<!-- /wp:button -->

<!-- wp:button {"backgroundColor":"dark-blue","className":"is-style-fill follow-us icon-twitter","style":{"border":{"radius":"50%"}}} -->
<div class="wp-block-button is-style-fill follow-us icon-twitter"><a class="wp-block-button__link has-dark-blue-background-color has-background wp-element-button" style="border-radius:50%">tw</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p class="has-text-align-left has-small-font-size">Copyright © 2024 Sekolah Alam Cikeas.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->